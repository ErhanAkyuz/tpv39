 ...
 * Generated at: 2022-03-17 14:28:37 UTC
...
public final class affichePanier_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	if (session.getAttribute("panier") == null) {
      ...
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t<li class=\"page_item page-item-2 current_page_item focus\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"");
 ...
 if (unArticle.getImage().startsWith("http")) 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
      out.print(new DecimalFormat("0.00").format(uneLignePanier.getPrixUnitaire()));
      out.write("€\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
 ...
 String random = UUID.randomUUID().toString().replaceAll("-", ""); 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"amount\">");
      out.print(new DecimalFormat("0.00").format(uneLignePanier.getPrixTotal()));
      out.write("€</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input class=\"button\" type=\"submit\" value=\"Mise à jour du panier\" name=\"update_cart\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"amount\">");
      out.print(new DecimalFormat("0.00").format((lePanier.getTotal())));
      out.write("€</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
